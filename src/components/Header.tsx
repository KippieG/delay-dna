      ...
      <div className="max-w-[1600px] mx-auto px-6 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative shrink-0">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-ecs-red"
                 style={{ background: 'linear-gradient(135deg, #CC0000 0%, #F5A800 100%)' }}>
          ...
          <div>
            <div className="flex items-center gap-1 leading-none">
              ...
              <span className="text-2xl font-extrabold tracking-tight"
                    style={{ background: 'linear-gradient(90deg,#CC0000,#F5A800)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                DNA
              </span>
            </div>
          ...
          {/* Context chip (hidden on small screens) */}
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="w-9 h-9 rounded-xl flex items-center justify-center text-sm font-bold text-white shadow"
               style={{ background: 'linear-gradient(135deg,#CC0000,#F5A800)' }}>
            PG
          </div>
        </div>
      </div>
